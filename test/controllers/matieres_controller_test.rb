...
class MatieresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matiere" do
    assert_difference('Matiere.count') do
      post matieres_url, params: { matiere: { matiere: @matiere.matiere, slug: @matiere.slug } }
    end
  ...
  test "should update matiere" do
    patch matiere_url(@matiere), params: { matiere: { matiere: @matiere.matiere, slug: @matiere.slug } }
